                ...
                <div class="col-md-2 mb-5">
                    <a href="<?php echo base_url('kategori/pakaian_hangat') ?>">
                        <span class="fa-stack fa-4x">
                            ...
                            <h4 class="my-3 font-rubik text-dark font-size-20 mr-3">Pakaian</h4>
                        </span>
                    </a>
                </div>
                ...
                <div class="col-md-2 mb-5">
                    <a href="<?php echo base_url('kategori/peralatan_masak') ?>">
                        <span class="fa-stack fa-4x">
                            ...
                            <h4 class="my-3 font-rubik text-dark font-size-20 mr-3">Alat Masak</h4>
                        </span>
                    </a>
                </div>
                ...
                <div class="col-md-2 mb-5">
                    <a href="<?php echo base_url('kategori/perlengkapan_trecking') ?>">
                        <span class="fa-stack fa-4x">
                            ...
                            <h4 class="my-3 font-rubik text-dark font-size-20 mr-3">Alat Hiking</h4>
                        </span>
                    </a>
                </div>
