...
<main id="main-site">
    ...
    <div id="carouselExampleIndicators" class="carousel slide mt-1" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="<?php echo base_url('assets/img/bnrn.png') ?>" alt="First slide">
            </div>
        </div>
    </div>
    <!-- !Carousel -->
    ...
    <section class="page-section" id="services">
        <div class="container text-dark py-4 mt-3 mb-5 font-rubik text-center">
            <div class="container">
                <h3 class="my-4 text-dark text-center">Apa Yang Disewakan Oleh Pandanaran Outdoor ?</h3>
                <hr>
            </div>
