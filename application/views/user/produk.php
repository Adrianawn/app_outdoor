...
<div class="container py-5">
    <h4 class="font-rubik font-size-20 text-dark">All Product</h4>
    <div id="fillters" class="button-group text-right">
        <button class="btn is-checked" data-filter="*">All</button>
        <button class="btn" data-filter="*">Promo</button>
        <button class="btn" data-filter="*">Bundle</button>
        <button class="btn" data-filter="*">Bags</button>
        <button class="btn" data-filter="*">Dome</button>
        <button class="btn" data-filter="*">Clothes</button>
        <button class="btn" data-filter="*">Cook Wear</button>
        <button class="btn" data-filter="*">Hike Wear</button>
        <button class="btn" data-filter="*">Accesories</button>
    </div>
    <hr>
</div>
